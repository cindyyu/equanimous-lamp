<new>
	<h1 class='logo'>
		<a href='/'><span class='yellow-text'>Free</span> Parking</a>
	</h1>
	<form class='grid' onsubmit={ addSpot }>
		...
		<div class='grid__col col--1-of-2'>
			<label for='price'>How much does it cost an hour?</label>
			<i class='material-icons'>attach_money</i><input type='text' name='price' />

			<label for='max_stay'>How long can you park here?</label>
